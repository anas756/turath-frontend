        ...
        <div className="form-inner verify-inner">
          ...
          {phase === 'loading' && (
            <>
              ...
              <p className="brand-label" style={{ marginTop: '1.5rem' }}>Turath Digital</p>
              <h1 className="auth-title verify-title">Verifying<br />your email</h1>
          ...
          {phase === 'success' && (
            <>
              <div className="confirmed-icon success-icon">
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#1e4d8c" strokeWidth="2">
                  <path d="M20 6 9 17l-5-5"/>
                </svg>
              </div>
              <p className="brand-label" style={{ marginTop: '1.5rem' }}>Turath Digital</p>
              <h1 className="auth-title verify-title">Email<br />confirmed!</h1>
              ...
              <button className="btn-cta" style={{ marginTop: '1.5rem' }} onClick={() => navigate('/login')}>
                Go to Login →
              </button>
            </>
          )}
          ...
          {phase === 'error' && (
            <>
              <div className="confirmed-icon error-icon">
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#c0392b" strokeWidth="2">
              ...
              <p className="brand-label" style={{ marginTop: '1.5rem' }}>Turath Digital</p>
              <h1 className="auth-title verify-title" style={{ fontSize: '2rem' }}>
